...
", entityType, element, accumulationMultiplier);
    }
...
", entityClass.getSimpleName(), element, accumulationMultiplier);
    }
    ...
    public static Optional<ElementType> getElementForEntity(Entity entity) {
        ...
        ElementType byType = PROJECTILE_ELEMENT_MAP.get(entity;
if (byType != null) return Optional.of(byType);
    ...
    public static Optional<Float> getAccumulationMultiplierForEntity(Entity entity) {
        if (entity == null) return Optional.empty();
        Float byType = PROJECTILE_ACCUM_MAP.get(entity;
if (byType != null) return Optional.of(byType);
